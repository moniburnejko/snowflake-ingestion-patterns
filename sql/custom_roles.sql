...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA poc_db.poc2_schema TO ROLE taskadmin;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA poc_db.poc2_schema TO ROLE taskadmin;
